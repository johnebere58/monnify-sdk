...
public class PinView extends AppCompatEditText {
    ...
    private final Boolean mViewIsExtensible;
    ...
    private final boolean expandToParentWidth;
    ...
    public PinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.monnifyPinViewStyle);
    }
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mViewType = a.getInt(R.styleable.PinView_monnifyPinViewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.PinView_monnifyPinViewItemCount, DEFAULT_COUNT);
        mCurrentItemCount = mPinItemCount;
        mMaxItemCount = a.getInt(R.styleable.PinView_monnifyPinViewMaxItemCount, mPinItemCount);
        mPinItemHeight = (int) a.getDimension(R.styleable.PinView_monnifyPinViewItemHeight,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.PinView_monnifyPinViewItemWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_size));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.PinView_monnifyPinViewItemSpacing,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.PinView_monnifyPinViewItemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.PinView_monnifyPinViewLineWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.PinView_monnifyPinViewLineColor);
        isCursorVisible = a.getBoolean(R.styleable.PinView_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.PinView_monnifyPinViewCursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.PinView_monnifyPinViewCursorWidth,
                res.getDimensionPixelSize(R.dimen.pv_pin_view_cursor_width));

        mViewIsExtensible = a.getBoolean(R.styleable.PinView_monnifyPinViewIsExtensible, false);

        mItemBackground = a.getDrawable(R.styleable.PinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.PinView_monnifyPinViewHideLineWhenFilled, false);

        expandToParentWidth = a.getBoolean(R.styleable.PinView_monnifyExpandToParentWidth, false);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (expandToParentWidth) {
            mPinItemWidth = widthSize / mPinItemCount;
        }
