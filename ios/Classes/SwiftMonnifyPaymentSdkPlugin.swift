...
public class SwiftMonnifyPaymentSdkPlugin: NSObject, FlutterPlugin {

  let ERROR_CODE_SDK_INITIALIZATION = "INIT_ERROR"
  let ERROR_CODE_PAYMENT_INITIALIZATION = "INIT_PAYMENT_ERROR"

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "monnify_payment_sdk", binaryMessenger: registrar.messenger())
    let instance = SwiftMonnifyPaymentSdkPlugin()
